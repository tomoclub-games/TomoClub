...
<head>
    ...
    <style>
        :root {
            --podcast-teal: #2AB4B8;
            --podcast-navy: #0F172A;
            --podcast-border: rgba(15, 23, 42, 0.08);
        }

        body {
            background-color: #FAFBFC;
            background-image: 
                radial-gradient(at 0% 0%, rgba(42, 180, 184, 0.05) 0px, transparent 50%),
        ...
        .sidebar-cta {
            ...
            position: sticky;
            top: 140px;
            box-shadow: 0 30px 60px -15px rgba(42, 180, 184, 0.3);
            text-align: center;
        }
        ...
        @media (max-width: 768px) {
            ...
            .episode-meta-bar { flex-direction: column; align-items: flex-start; width: 100%; }
