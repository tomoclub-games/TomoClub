...
source_img = r'c:\Users\JANMEJAY\Desktop\tom\shane.jpg'
dest_img = r'c:\Users\JANMEJAY\Desktop\tom\articles\images\shane.jpg'
...
article_html = html_template.format(
    ...
    date="June 19, 2026",
    cover_local="../../articles/images/shane.jpg",
    cover_local_name="shane.jpg",
    slug=slug,
    content=content
)
...
new_card = f'''
                <a href="articles/{slug}/" class="glass-card" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease; padding: 0; overflow: hidden;" target="_blank">
                    <div style="background: var(--card-grad-teal); height: 100%; display: flex; flex-direction: column;">
                        <img src="articles/images/shane.jpg" alt="Shane Ogden" style="width: 100%; height: 220px; object-fit: cover; border-bottom: 1px solid var(--border-color);">
